...
import static org.jeecg.modules.system.controller.LoginController.RETRY_NAME;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements ISysUserService {
    ...
    @Override
    @CacheEvict(value = {CacheConstant.SYS_USERS_CACHE}, allEntries = true)
    public Result<?> changePassword(SysUser newSysUser,SysUser sysUser) {
        ...
        String newPassword = newSysUser.getPassword();
        String passwordEncode = PasswordUtil.encrypt(sysUser.getUsername(), newPassword, salt);
		newSysUser.setPassword(passwordEncode);
        this.userMapper.updateById(newSysUser);
