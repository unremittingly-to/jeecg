package org.jeecg.customer.controller;
...
public class CustomerController extends JeecgController<Customer, ICustomerService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "客户管理表-分页列表查询")
	@ApiOperation(value="客户管理表-分页列表查询", notes="客户管理表-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "客户管理表-添加")
	@ApiOperation(value="客户管理表-添加", notes="客户管理表-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "客户管理表-编辑")
	@ApiOperation(value="客户管理表-编辑", notes="客户管理表-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "客户管理表-通过id删除")
	@ApiOperation(value="客户管理表-通过id删除", notes="客户管理表-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "客户管理表-批量删除")
	@ApiOperation(value="客户管理表-批量删除", notes="客户管理表-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "客户管理表-通过id查询")
	@ApiOperation(value="客户管理表-通过id查询", notes="客户管理表-通过id查询")
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, Customer customer) {
        return super.exportXls(request, customer, Customer.class, "客户管理表");
    }
